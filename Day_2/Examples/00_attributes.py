...
# print(hasattr(p, 'name'))  # p.name Out: True
#
# del People.name
# pprint(People.__dict__)
# print(hasattr(p, 'name'))  # p.name Out: False
...
# p.name = 'Students'
# p.age = 22
# pprint(p.__dict__, sort_dicts=False)
# #
...
# field = 'name'
# print(getattr(People, field))  # Out: People.name -> SName
...
# print(Student.__self__)  # AttributeError
