...
# ключи словаря: str,bool, int, float, tuple, range, frozenset
class Vector:
    def __init__(self, pos: list | tuple):  # Какой тип данных может быть у pos? tuple, list, str, dict
        self.x = pos[0]
        self.y = pos[1]

    # Реализация оператора +, неявный метод  v1.__add__(v2)
...
print(f'{something = !s}')
# some_v2 = slonik + v2   # slonik.__add__(v2) Error(2)
